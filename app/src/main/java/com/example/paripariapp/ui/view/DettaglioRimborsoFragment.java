...
public class DettaglioRimborsoFragment extends Fragment {
    ...
    private void setupWindowInsets() {
        ViewCompat.setOnApplyWindowInsetsListener(binding.getRoot(), (v, insets) -> {
            ...
            binding.scrollDettaglioRimborso.setPadding(
                    binding.scrollDettaglioRimborso.getPaddingLeft(),
                    binding.scrollDettaglioRimborso.getPaddingTop(),
                    binding.scrollDettaglioRimborso.getPaddingRight(),
